...
#
# =====================================================================
# The Main Menu starts on line 1725.  Recommend configuring the
...
function set_vars {
    ...
    technology2=$(nstatbl "technology" | cut -f3 -d' ') # not used
    ...
    #
    # Uppercase spelling changes in v3.11.  Prefer common spelling.
    if [[ "$technology" == "OPENVPN" ]]; then technology="OpenVPN"; fi
    if [[ "$technology" == "NORDLYNX" ]]; then technology="NordLynx"; fi
    #
