...
do
    case $opt in
        ...
        "Discord")
            discon
            echo
            echo  "** streamhd247.live **  VLC stream"
            echo 
            echo "Discord recognized IP ca1044" 
            echo
            nordvpn connect ca1044
            status
            /usr/bin/firefox --new-window https://discordapp.com/channels/402316379786706945/440712528729866243
            break
            ;;
        "Restart")
            echo
